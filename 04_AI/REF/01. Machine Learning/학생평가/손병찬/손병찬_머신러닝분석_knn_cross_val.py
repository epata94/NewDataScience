...
# MAX 조합: sex cp oldpeak slope ca thal >> 86.15 %
# 프로그램 소요 시간:  0:02:25.879600

 # 독립변수 최적화 분석 결과
# knn=7
# 총 조합 갯수: 8191, 1개~14개의 독립변수 조합
# MAX 조합: cp fbs restecg exang slope ca thal >> 85.85 %
# 85.51 %
# 프로그램 소요 시간:  0:02:25.931801

 # 독립변수 최적화 분석 결과
# k-nn=2
# 총 조합 갯수: 8191, 1개~14개의 독립변수 조합
# MAX 조합: sex fbs restecg exang ca thal >> 81.22 %
# 프로그램 소요 시간:  0:02:46.502500
