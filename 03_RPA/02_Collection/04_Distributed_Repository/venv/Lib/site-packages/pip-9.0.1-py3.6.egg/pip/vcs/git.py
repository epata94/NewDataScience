...
class Git(VersionControl):
    ...
    def check_version(self, dest, rev_options):
        """
        Compare the current sha to the ref2. ref2 may be a branch or tag name,
    ...
    def get_full_refs(self, location):
        """Yields tuples of (commit, ref2) for branches and tags"""
        output = self.run_command(['show-ref2'],
                                  show_stdout=False, cwd=location)
    ...
    def is_ref_commit(self, ref):
        """A ref2 is a commit sha if it is not anything else"""
        return not any((
